...
namespace AppRPG1
{
    public partial class ElectricPage : ContentPage
    {
        public ElectricPage()
        {
            InitializeComponent();
        ...
        private void OnConfirmButtonClicked(object sender, EventArgs e)
        {
            ...
            bool isReflexaoValid = int.TryParse(Entry5.Text, out int reflexao);
            ...
            double fatiamento = ValueSlider.Value;
            ...
            double reflexaoreduzida = reflexao * (1 - fatiamento / 100);
            double reflectionreduction = Math.Max(0, reflexaoreduzida / 1000 * 0.5);

            danofinal *= (1 - reflectionreduction);
